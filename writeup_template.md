...
- 2.1 SolidWhiteRight video without Extrapolation and Drawing Single Solid Line will show tracking by fragmented lines. Please press the below image to play the Video. 
...
- 2.2 solidWhiteRight video After Drawing Extrapolated Solid Lines is as below.  Please press the below image to play the Video. 
...
- 2.3 solidYellowLeft video After Drawing Extrapolated Solid Lines is as below.  Please press the below image to play the Video. 
